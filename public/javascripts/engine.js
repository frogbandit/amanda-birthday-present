(function(){
  ...
  function tellStep20() {
    ...
    setTimeout(function() {
      newStoryLog("INTERCOM: \"We have landed at San Francisco International Airport.\"");
      setTimeout(function() {
        newStoryLog("INTERCOM: \"The time is 4:20 PM, and the temperature is 72 degrees Fahrenheit. Thank you again for flying with us.\"");
        setTimeout(function() {
